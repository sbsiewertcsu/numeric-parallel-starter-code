...
#define MAX (1000000000ULL) // 1 billion
//#define MAX (0xFFFFFFFFULL) // > 4 billion
//#define MAX (0xFFFFFFFFFFFFFFFFULL) // > 16 quintillion (1000,000 x a trillion)
...
int main(void)
{
        ...
        printf("Will look for primes up to %llu\n", MAX);
        ...
        {
            printf("Allocated %llu bytes (%llu MBytes) for prime invalidation map for %llu bits\n", 
                   (MAX/(CODE_LENGTH))+1, ((MAX/(CODE_LENGTH))+1)/(1024*1024), MAX);
        }
