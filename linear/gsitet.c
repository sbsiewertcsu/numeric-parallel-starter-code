...
// EXTI TICKET re-arranged to be as DIAG DOM as possible
// 33x + 4.2y -33z = 17
// -4x -17y +7z = 42
// 0.5x + 11y -3.2z = -22.1

//x = (17.0 - 4.2y + 33.0z)/33.0
//y = (-42.0 - 4.0x + 7.0z)/17.0
//z = (22.1 + 0.5x + 11.0y)/3.2

// EXIT TICKET that is not Diag Dom but works
#define f1(x,y,z)  (17.0-4.2*y+33.0*z)/33.0
#define f2(x,y,z)  (-42.0-4.0*x+7.0*z)/17.0
#define f3(x,y,z)  (22.1+0.5*x+11.0*y)/3.2

// For verification, enter the coefficients into this array to match equations
double a[DIM][DIM] = {{33.0, 4.2, -33.0}, {-4.0, -17.0, 7.0}, {0.5, 11.0, -3.2}};
double b[DIM] = {17.0, 42.0, -22.1};
double x[DIM]={0.0, 0.0, 0.0};
int n = DIM;
