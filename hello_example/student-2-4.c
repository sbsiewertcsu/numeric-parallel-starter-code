...
// Put pragma in best location for speed-up and be careful to specify reduction, private and shared variables
...
double time, sum=0.0;
#pragma omp parallel for reduction(+:sum) private(time) shared(steps, step_size)
